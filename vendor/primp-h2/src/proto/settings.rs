...
impl Settings {
    ...
    /// ALPS settings arrive during TLS, before the HTTP/2 connection preface.
    /// They are already authenticated by TLS and must not elicit a SETTINGS ACK.
    pub(crate) fn note_alps_settings(&mut self) {
